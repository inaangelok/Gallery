    ...
    if (count($photos) > 4) {
        ...
        <div class="control-btns">
            <div class="prev" id="prevpaginate">
                <button class="controlbtn" type="button" onclick="paginate(-4)"><img src="../assets/front/img/prev.png"
                                                                                     alt="Prev">Prev Page
                </button>
            </div>
            <div class="prev" id="nextpaginate">
                <button class="controlbtn" onclick="paginate(4)">Next Page<img src="../assets/front/img/next.png"
                                                                               alt="Prev"></button>
            </div>
        </div>
    <?php }
